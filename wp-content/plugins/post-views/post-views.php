...
function post_views_textdomain() {
	load_plugin_textdomain('post-views', 'post-views/lang');
}
...
$pv_menu = "
							...
							<a href=\"http://ziming.org/dev/post-views\" target=\"_blank\">".__('Help','post-views')."</a>
	            ";
...
?>	
	<thead>
	<tr>				
				<th class="manage-column" scope="col"><?php _e('Realtime Viewed Coverage ( Today )','post-views') ?></th>
	...
	<thead>
	<tr>				
				<th class="manage-column" scope="col"><?php _e('Realtime Viewed Coverage ( Week )','post-views') ?></th>
				<th class="manage-column" scope="col" colspan="3"><?php _e('Historical Viewed Coverage (%)','post-views') ?></th>
	</tr>
	</thead>
	<tr>
	...
	<thead>
	<tr>	<th class="manage-column" scope="col" ><?php _e('Realtime Viewed Coverage ( Month )','post-views') ?></th>
				<th class="manage-column" scope="col"  colspan="3"><?php _e('Historical Viewed Coverage (%)','post-views') ?></th>
	</tr>
	</thead>
	<tr>
	...
	<thead>
	<tr>				
				<th class="manage-column" scope="col"><?php _e('Realtime Viewed Coverage ( Half Year )','post-views') ?></th>
				<th class="manage-column" scope="col"><?php _e('Realtime Viewed Coverage ( Year )','post-views') ?></th>
				<th class="manage-column" scope="col"><?php _e('Realtime Viewed Coverage ( Total )','post-views') ?></th>
				<th class="manage-column" scope="col"><?php _e('Realtime Views Contribution','post-views') ?></th>
	</tr>
	</thead>
	<tr>
...
?>
	...
	<tr>				
				<th class="manage-column" scope="col"><?php _e('Realtime Viewed Coverage ( Today )','post-views') ?></th>
				<th class="manage-column" scope="col" colspan="3"><?php _e('Historical Viewed Coverage ( Day )','post-views') ?></th>
	</tr>
	</thead>
	<tr>
				<td><img src="https://chart.googleapis.com/chart?cht=p&amp;chd=t:<?php echo get_post_viewed_coverage($view_type,'today',$output_type,'+','100');?>,<?php echo get_post_viewed_coverage($view_type,'today',$output_type,'-','100');?>&amp;chds=0,<?php echo $post_count; ?>&amp;chs=250x180&amp;chdl=<?php echo get_post_viewed_coverage($view_type,'today',$output_type,'+','%'); ?> Read|<?php echo get_post_viewed_coverage($view_type,'today',$output_type,'-','%');?> Unread&amp;chco=206582"></td>
	...
	<tr>				
				<th class="manage-column" scope="col"><?php _e('Realtime Viewed Coverage ( Week )','post-views') ?></th>
				<th class="manage-column" scope="col" colspan="3"><?php _e('Historical Viewed Coverage ( Week )','post-views') ?></th>
	</tr>
	</thead>
	<tr>
				<td><img src="https://chart.googleapis.com/chart?cht=p&amp;chd=t:<?php echo get_post_viewed_coverage($view_type,'week',$output_type,'+','100');?>,<?php echo get_post_viewed_coverage($view_type,'week',$output_type,'-','100');?>&amp;chds=0,<?php echo $post_count; ?>&amp;chs=250x160&amp;chdl=<?php echo get_post_viewed_coverage($view_type,'week',$output_type,'+','%'); ?> Read|<?php echo get_post_viewed_coverage($view_type,'week',$output_type,'-','%');?> Unread&amp;chco=206582"></td>
	...
	<thead>
	<tr>	<th class="manage-column" scope="col" ><?php _e('Realtime Viewed Coverage ( Month )','post-views') ?></th>
				<th class="manage-column" scope="col"  colspan="3"><?php _e('Historical Viewed Coverage ( Month )','post-views') ?></th>
	</tr>
	</thead>
	<tr>
				<td><img src="https://chart.googleapis.com/chart?cht=p&amp;chd=t:<?php echo get_post_viewed_coverage($view_type,'month',$output_type,'+','100');?>,<?php echo get_post_viewed_coverage($view_type,'month',$output_type,'-','100');?>&amp;chds=0,<?php echo $post_count; ?>&amp;chs=250x160&amp;chdl=<?php echo get_post_viewed_coverage($view_type,'month',$output_type,'+','%'); ?> Read|<?php echo get_post_viewed_coverage($view_type,'month',$output_type,'-','%');?> Unread&amp;chco=206582"></td>
...
function post_view_trigger_update($v_type,$id,$o_type){
	...
	if($max_time_span['diff_d']){
		...
		$temp_normal_viewed_today = $wpdb->get_var($wpdb->prepare("select count(post_views_today) FROM ".WP_POST_VIEWS_TABLE." where view_type='normal' and output_type='content' and post_views_today !=0 "));
		$temp_normal_viewed_week = $wpdb->get_var($wpdb->prepare("select count(post_views_week) FROM ".WP_POST_VIEWS_TABLE." where view_type='normal' and output_type='content' and post_views_week !=0 "));
		$temp_normal_viewed_month = $wpdb->get_var($wpdb->prepare("select count(post_views_month) FROM ".WP_POST_VIEWS_TABLE." where view_type='normal' and output_type='content' and post_views_month !=0 "));
		$temp_normal_viewed_halfyear = $wpdb->get_var($wpdb->prepare("select count(post_views_halfyear) FROM ".WP_POST_VIEWS_TABLE." where view_type='normal' and output_type='content' and post_views_halfyear !=0 "));
		$temp_normal_viewed_year = $wpdb->get_var($wpdb->prepare("select count(post_views_year) FROM ".WP_POST_VIEWS_TABLE." where view_type='normal' and output_type='content' and post_views_year !=0 "));
		
		$temp_normal_previewed_today = $wpdb->get_var($wpdb->prepare("select count(post_views_today) FROM ".WP_POST_VIEWS_TABLE." where view_type='normal' and output_type='excerpt' and post_views_today !=0 "));
		$temp_normal_previewed_week = $wpdb->get_var($wpdb->prepare("select count(post_views_week) FROM ".WP_POST_VIEWS_TABLE." where view_type='normal' and output_type='excerpt' and post_views_week !=0 "));
		$temp_normal_previewed_month = $wpdb->get_var($wpdb->prepare("select count(post_views_month) FROM ".WP_POST_VIEWS_TABLE." where view_type='normal' and output_type='excerpt' and post_views_month !=0 "));
		$temp_normal_previewed_halfyear = $wpdb->get_var($wpdb->prepare("select count(post_views_halfyear) FROM ".WP_POST_VIEWS_TABLE." where view_type='normal' and output_type='excerpt' and post_views_halfyear !=0 "));
		$temp_normal_previewed_year = $wpdb->get_var($wpdb->prepare("select count(post_views_year) FROM ".WP_POST_VIEWS_TABLE." where view_type='normal' and output_type='excerpt' and post_views_year !=0 "));
...
function get_post_views_trend($view_type,$time_span,$output_type,$year_id,$post_id = 0){
	...
	if($post_id == 0){
  		...
  		$trend = $wpdb->get_var($wpdb->prepare("SELECT ".$time_span." FROM ".WP_POST_VIEWS_SUMMARY_TABLE." where summary_type='".$view_type."_".$output_type."' and year_id=".$year_id));
	}else{
		  $trend = $wpdb->get_var($wpdb->prepare("SELECT ".$time_span." FROM ".WP_POST_VIEWS_HIS_TABLE." where post_id =".$post_id." and view_type ='".$view_type."' and output_type ='".$output_type."' and year_id=".$year_id));		
	}
...
function get_post_viewed_coverage_trend($view_type,$time_span,$output_type,$year_id){
  ...
  $trend = $wpdb->get_var($wpdb->prepare("SELECT ".$time_span." FROM ".WP_POST_VIEWS_SUMMARY_TABLE." where summary_type='".$view_type."_".$output_type."_coverage' and year_id=".$year_id));
	return  $trend;
}
