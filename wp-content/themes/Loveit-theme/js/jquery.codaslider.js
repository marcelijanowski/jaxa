...
jQuery(function(){
	...
	// Preloader
	jQuery(".coda-slider").children('.panel').hide().end().prepend('<p class="loading">Loading...<br /><img src="wp-content/themes/deadline/images/ajax-loader.gif" alt="loading..." /></p>');
});
...
jQuery.fn.codaSlider = function(settings) {
	...
	settings = jQuery.extend({
		...
		externalTriggerSelector: "a.link-nav-slider",
		firstPanelToLoad: 1,
		panelTitleSelector: "h2.entry-title",
	...
	return this.each(function(){
		...
		if (settings.dynamicTabs) {
			...
			switch (settings.dynamicTabsAlign) {
				case "center":
					ul.css({ width: (jQuery("li", ul).width()) * panelCount });
					break;
				case "right":
					ul.css({ float: 'right' });
					break;
